...
import recentEvent2 from "../../../assets/background_patterns/event5.png";
  ...
  return (
    <>
      ...
      <Box sx={{ width: "90%", margin: "0 auto", padding: "5% 0 10%" }}>
        <Typography variant="h1" sx={{ margin: "0% 0 3%" }}>
          My Orders
        </Typography>
              ...
              <Box
                ...
                sx={{
                  ...
                  boxShadow: `${hexToRGBA(
                    orange,
                    0.3
                  )} 0px 10px 100px -20px, ${hexToRGBA(
                    dark1,
                    0.3
                  )} 0px 30px 60px -30px, ${hexToRGBA(
                    dark1,
                    0.35
              ...
              >
                ...
                >
                  <Box sx={{ textAlign: "center" }}>
                    ...
                    <Typography variant="h2" sx={{ margin: "4% 0" }}>
                      Order {item.eventId}
                    </Typography>
                    <Box
                      sx={{
