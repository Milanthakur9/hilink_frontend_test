      ...
      >
        <Box sx={{ width: { md: "48%", xs: "95%" } }}>
          ...
          <Typography
            ...
            sx={{
              margin: "2% 0",
              background: `linear-gradient(to bottom,${orange},${hexToRGBA(
                dark1,
                0.8
              )})`,
              backgroundClip: "text",
          ...
          >
            Join us in redefining how events are curated, shared, and
            celebrated.
          </Typography>
          <Typography variant="subtitle1">
            Discover your next adventure with a curated feed of tailored event
            recommendations and opportunities to connect with people in real
            life, all on the HiLink VIP mobile app.
          </Typography>
          <Typography variant="subtitle1" sx={{ margin: "2% 0" }}>
            Get Paid Instantly - Cover upfront costs effortlessly with real-time
            access to funds as your tickets sell. Say goodbye to waiting until
            after your event to receive your payouts!
          </Typography>
          <Button
            sx={{
              margin: "3% 0 0 0",
